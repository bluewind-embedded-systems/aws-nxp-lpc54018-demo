...
1.  In the [Amazon Cognito Console here](https://console.aws.amazon.com/cognito/) select "Manage Federated Identities" and "Create new identity pool".
...
5.  As part of creating the identity pool Cognito [will setup two roles in Identity and Access Management (IAM, see here)](https://console.aws.amazon.com/iam/home#roles).
